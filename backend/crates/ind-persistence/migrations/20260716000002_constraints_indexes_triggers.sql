...
ALTER TABLE ONLY public.email_ingest_log
    ADD CONSTRAINT email_ingest_log_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.ai_outputs
    ADD CONSTRAINT fk_ai_outputs_run FOREIGN KEY (ai_run_id) REFERENCES public.ai_runs(id);

ALTER TABLE ONLY public.ai_prompt_presets
    ADD CONSTRAINT fk_ai_prompt_presets_user FOREIGN KEY (user_id) REFERENCES public.users(id);

ALTER TABLE ONLY public.ai_runs
    ADD CONSTRAINT fk_ai_runs_document FOREIGN KEY (document_id) REFERENCES public.documents(id) ON DELETE SET NULL;

ALTER TABLE ONLY public.ai_runs
    ADD CONSTRAINT fk_ai_runs_user FOREIGN KEY (user_id) REFERENCES public.users(id);

ALTER TABLE ONLY public.api_tokens
    ADD CONSTRAINT fk_api_tokens_user FOREIGN KEY (user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.billing_account_members
    ADD CONSTRAINT fk_bam_user FOREIGN KEY (user_id) REFERENCES public.users(id);

ALTER TABLE ONLY public.billing_accounts
    ADD CONSTRAINT fk_billing_accounts_owner FOREIGN KEY (owner_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.collections
    ADD CONSTRAINT fk_collections_user FOREIGN KEY (user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.domain_events
    ADD CONSTRAINT fk_domain_events_user FOREIGN KEY (user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.entities
    ADD CONSTRAINT fk_entities_user FOREIGN KEY (user_id) REFERENCES public.users(id);

ALTER TABLE ONLY public.entitlement_snapshots
    ADD CONSTRAINT fk_entitlement_snapshots_plan FOREIGN KEY (effective_plan_id) REFERENCES public.plans(id);

ALTER TABLE ONLY public.entitlement_snapshots
    ADD CONSTRAINT fk_entitlement_snapshots_user FOREIGN KEY (user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.feed_subscriptions
    ADD CONSTRAINT fk_feed_subscriptions_collection FOREIGN KEY (auto_save_collection_id) REFERENCES public.collections(id);

ALTER TABLE ONLY public.feed_subscriptions
    ADD CONSTRAINT fk_feed_subscriptions_source FOREIGN KEY (source_id) REFERENCES public.feed_sources(id) ON DELETE CASCADE;

ALTER TABLE ONLY public.feed_subscriptions
    ADD CONSTRAINT fk_feed_subscriptions_user FOREIGN KEY (user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.highlights
    ADD CONSTRAINT fk_highlights_user FOREIGN KEY (user_id) REFERENCES public.users(id);

ALTER TABLE ONLY public.import_job_items
    ADD CONSTRAINT fk_import_job_items_job FOREIGN KEY (import_job_id) REFERENCES public.import_jobs(id) ON DELETE CASCADE;

ALTER TABLE ONLY public.import_jobs
    ADD CONSTRAINT fk_import_jobs_user FOREIGN KEY (user_id) REFERENCES public.users(id);

ALTER TABLE ONLY public.integration_connections
    ADD CONSTRAINT fk_integration_connections_user FOREIGN KEY (user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.integration_oauth_tokens
    ADD CONSTRAINT fk_integration_oauth_tokens_user FOREIGN KEY (user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.item_notes
    ADD CONSTRAINT fk_item_notes_user FOREIGN KEY (user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.lifecycle_actions
    ADD CONSTRAINT fk_lifecycle_actions_user FOREIGN KEY (user_id) REFERENCES public.users(id);

ALTER TABLE ONLY public.mila_config
    ADD CONSTRAINT fk_mila_config_user FOREIGN KEY (user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.notification_preferences
    ADD CONSTRAINT fk_notification_preferences_user FOREIGN KEY (user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.oauth_identities
    ADD CONSTRAINT fk_oauth_user FOREIGN KEY (user_id) REFERENCES public.users(id);

ALTER TABLE ONLY public.password_reset_tokens
    ADD CONSTRAINT fk_password_reset_user FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;

ALTER TABLE ONLY public.push_tokens
    ADD CONSTRAINT fk_push_tokens_user FOREIGN KEY (user_id) REFERENCES public.users(id);

ALTER TABLE ONLY public.recent_searches
    ADD CONSTRAINT fk_recent_searches_user FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;

ALTER TABLE ONLY public.referral_credits
    ADD CONSTRAINT fk_referral_credits_user FOREIGN KEY (user_id) REFERENCES public.users(id);

ALTER TABLE ONLY public.review_cards
    ADD CONSTRAINT fk_review_cards_highlight FOREIGN KEY (highlight_id) REFERENCES public.highlights(id) ON DELETE CASCADE;

ALTER TABLE ONLY public.review_cards
    ADD CONSTRAINT fk_review_cards_user FOREIGN KEY (user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.search_documents
    ADD CONSTRAINT fk_search_documents_user FOREIGN KEY (user_id) REFERENCES public.users(id);

ALTER TABLE ONLY public.smart_lists
    ADD CONSTRAINT fk_smart_lists_user FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;

ALTER TABLE ONLY public.storage_add_ons
    ADD CONSTRAINT fk_storage_add_ons_user FOREIGN KEY (user_id) REFERENCES public.users(id);

ALTER TABLE ONLY public.subscriptions
    ADD CONSTRAINT fk_subscriptions_account FOREIGN KEY (billing_account_id) REFERENCES public.billing_accounts(id);
...
ALTER TABLE ONLY public.tags
    ADD CONSTRAINT fk_tags_user FOREIGN KEY (user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.usage_counters
    ADD CONSTRAINT fk_usage_counters_user FOREIGN KEY (user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.webhook_deliveries
    ADD CONSTRAINT fk_webhook_deliveries_event FOREIGN KEY (domain_event_id) REFERENCES public.domain_events(id);
...
ALTER TABLE ONLY public.webhook_dispatches
    ADD CONSTRAINT fk_webhook_dispatches_event FOREIGN KEY (domain_event_id) REFERENCES public.domain_events(id);

ALTER TABLE ONLY public.webhook_endpoints
    ADD CONSTRAINT fk_webhook_endpoints_user FOREIGN KEY (user_id) REFERENCES public.users(id);
