...
use ind_application::repos::content_vector::SingleDocumentFtsQuery;
...
impl PgContentVectorRepository {
    pub(in crate::repos::content_vector_repo) async fn fts_single_document_impl(
        &self,
