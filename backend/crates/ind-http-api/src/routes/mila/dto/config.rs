...
mod tests {
    ...
    #[test]
    fn provider_test_body_carries_reasoning_capability() {
        let body: TestMilaConfigBody = serde_json::from_value(serde_json::json!({
        ...
        assert!(body.into_state_request().supports_reasoning_effort);
    }
}
