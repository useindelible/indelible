<script lang="ts">
	...
	interface Props {
		...
		onToggleScope: (scope: ScopeKey) => void;
...
<div class="issue-form" class:open>
	<div class="issue-form-inner">
		...
		<div class="form-row">
			<div class="lab">Scopes<span class="help">Pick exactly what this token can do.</span></div>
			<div class="scope-grid">
				{#each scopeDefs as scope (scope.key)}
					<button
						type="button"
						class="scope-card"
						class:selected={scopes.has(scope.key)}
						onclick={() => onToggleScope(scope.key)}
					>
						<div class="scope-head">
							<span class="key">{scope.key}</span>
							<span class="check">
