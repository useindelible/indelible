...
<SettingsHero variant="developer">
	<div class="hero-text">
		<div>
			...
			<p class="hero-sub">
				Mint tokens to call the API. Subscribe webhooks to push events the other way. Both share the
				same scopes, the same signing convention, and the same audit trail.
			</p>
		</div>
