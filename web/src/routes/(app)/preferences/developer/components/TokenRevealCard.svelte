<script lang="ts">
	...
	let { token, copied, onCopy, onDismiss }: Props = $props();
</script>
...
{#if token}
	<div class="reveal">
		...
		<div class="reveal-desc">
			Copy and store this token in a password manager or your CLI's credential file. We hash and
			discard it after this dialog closes — it can't be recovered, only revoked.
		</div>
