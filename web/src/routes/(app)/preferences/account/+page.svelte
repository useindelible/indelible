<script lang="ts">
	...
	let emailRevealOpen = $state(false);
	let newEmail = $state('');
	...
	function openEmailReveal() {
		emailRevealOpen = true;
	}

	function cancelEmailReveal() {
...
<div class="account-content">
	...
	<div class="body-area">
		...
		<EmailVerificationSection
			...
			onOpen={openEmailReveal}
			onCancel={cancelEmailReveal}
			onNewEmailChange={(value) => (newEmail = value)}
			onCurrentPasswordChange={(value) => (emailCurrentPassword = value)}
		/>
