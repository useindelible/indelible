		...
		<div class="detail-scroll">
			<div class="detail-entity-header">
				...
				<div class="detail-type-row">
					<span class="detail-type-pill">{TYPE_LABELS[e.entity_type] ?? e.entity_type}</span>
				</div>
			</div>
			...
			{#if e.description}
				<div class="detail-about-section">
					...
					<div class="detail-about-attribution">Generated by Mila</div>
				</div>
			{/if}
...
{#snippet content()}
	{#if loading}
		<div class="entity-page-state">Loading...</div>
	{:else if error || !entity}
		<div class="entity-page-state">{error ?? 'Entity not found.'}</div>
	{:else}
			...
			<div class="main-scroll">
				...
				<div class="entity-header">
					...
					<div class="entity-name-row">
						...
						<span class="entity-type-pill"
							>{TYPE_LABELS[entity.entity_type] ?? entity.entity_type}</span
						>
						{#if vp.isCompact}
							<button
								type="button"
								...
								aria-label={compactDetailOpen ? 'Hide info panel' : 'Show info panel'}
								title={compactDetailOpen ? 'Hide info panel' : 'Show info panel'}
							>
								<svg
									viewBox="0 0 20 20"
									fill="none"
					...
					<div class="entity-stats">
						<span>{entity.total_mentions} references</span>
						<span class="stat-dot"></span>
						<span>{entity.item_count} documents</span>
						<span class="stat-dot"></span>
						<span>First seen {formatDate(entity.first_seen_at)}</span>
						<span class="stat-dot"></span>
						<span>Last seen {formatDate(entity.last_seen_at)}</span>
					</div>
				</div>
				...
				{#if entity.co_occurring.length > 0}
					<div class="co-entities-section">
						<div class="section-title">Frequently mentioned with</div>
					...
					<div class="documents-section">
						<div class="section-header-row">
							<div class="section-title-with-count">
								...
								<span class="section-count">{entity.item_count} documents</span>
							</div>
						</div>
						<div class="doc-list">
