...
fun AddLibraryScreen(
    ...
    LaunchedEffect(viewModel) {
        viewModel.effects.collect { effect ->
            when (effect) {
                is AddLibraryEffect.ShowSnackbar -> snackbarHostState.showSnackbar(effect.message)
                is AddLibraryEffect.NavigateBack -> onNavigateBack()
            }
        }
    }
        ...
        Column(
            ...
            SettingsSection(title = "Save to Library") {
                ...
                IndelibleButton(
                    ...
                    isLoading = uiState is AddLibraryUiState.Loading,
