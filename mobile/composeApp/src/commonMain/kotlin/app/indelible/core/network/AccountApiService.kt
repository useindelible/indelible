...
import app.indelible.api.generated.client.ApiV1MeAvatarUploadUrlClient
...
import app.indelible.api.generated.models.AvatarUploadUrlRequest
import app.indelible.api.generated.models.AvatarUploadUrlResponse
...
class AccountApiService(
    ...
    suspend fun getAvatarUploadUrl(contentType: String): Result<AvatarUploadUrlResponse> =
        transport.authenticatedRequest { client, configuration ->
            ApiV1MeAvatarUploadUrlClient(client).avatarUploadUrl(AvatarUploadUrlRequest(contentType), configuration)
        }
