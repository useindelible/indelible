...
export type DeliveryHistoryTick = 's2xx' | 's4xx' | 's5xx' | 'pending'
...
export type GetDocumentAssetResponses = {
  /**
   * Asset metadata with presigned download URL
   */
...
export type DownloadObsidianArtifactErrors = {
  ...
  401: unknown
  /**
   * obsidian_plugin scope required
   */
  403: unknown
  /**
   * Artifact not found
...
export type AvatarUploadUrlData = {
...
export type AvatarUploadUrlErrors = {
  /**
   * Authentication required
   */
  401: unknown
...
export type AvatarUploadUrlResponses = {
  /**
...
export type AvatarUploadUrlResponse2 = AvatarUploadUrlResponses[keyof AvatarUploadUrlResponses]
